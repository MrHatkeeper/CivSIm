...
class Human:
    ...
    def killHuman(self):
        ...
        if self.happiness < EConfig.DEATHBORDER.value:
    ...
    def evalHappiness(self):
        ...
        self.happiness += (self.hunger * -1) * EConfig.HUNGRYINC.value + EConfig.HUNGRYINC.value
    ...
    def reproduce(self):
        ...
        if id(self) > id(partner):
            return
        base_chance = EConfig.BIRTHRATIO.value
        ...
        if self.house is not None:
            ...
            happiness_factor = (self.happiness + partner.happiness) / 2
            chance = base_chance * EConfig.HOMELESSBIRTHRATIO.value * (happiness_factor / 100)
